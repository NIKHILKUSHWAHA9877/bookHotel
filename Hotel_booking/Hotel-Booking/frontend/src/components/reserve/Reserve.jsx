  ...
  const handeSelect=(e)=>{
    ...
    const handelClick = async () => {
      try {
        ...
        // Reservation was successful, show an alert
        window.alert('Room(s) booked successfully!');
        
        setOpen(false);
        navigate("/");
      } catch (err) {
        // Handle any errors that may occur during reservation
        console.error(err);
        // Optionally, you can show an error alert here as well
        window.alert('An error occurred during room reservation.');
      }
    };
